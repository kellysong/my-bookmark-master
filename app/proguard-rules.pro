...
-keepclassmembers class com.sjl.bookmark.widget.X5WebView {
   public *;
}
...
#修复升级gradle后DaoConifg找不到问题20200401
...
## EventBus 3.1.1,不知道为啥放在子模块配置混淆失败???
...
# ButterKnife 7.0.1,不知道为啥放在子模块配置混淆失败???，但是 8.4.0不需要再app下配置混淆
