...
import com.sjl.bookmark.widget.reader.animation.CoverPageAnim;
import com.sjl.bookmark.widget.reader.animation.HorizonPageAnim;
import com.sjl.bookmark.widget.reader.animation.NonePageAnim;
import com.sjl.bookmark.widget.reader.animation.PageAnimation;
import com.sjl.bookmark.widget.reader.animation.ScrollPageAnim;
import com.sjl.bookmark.widget.reader.animation.SimulationPageAnim;
import com.sjl.bookmark.widget.reader.animation.SlidePageAnim;
import com.sjl.bookmark.widget.reader.bean.PageMode;
import com.sjl.bookmark.widget.reader.loader.LocalPageLoader;
import com.sjl.bookmark.widget.reader.loader.NetPageLoader;
...
public class PageView extends View {
     ...
     * @return
     */
    public PageLoader getPageLoader(CollectBook collBook) {
        // 判是否已经存在
        if (mPageLoader != null) {
            return mPageLoader;
        }
