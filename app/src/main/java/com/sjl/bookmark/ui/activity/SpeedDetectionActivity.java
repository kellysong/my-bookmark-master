...
import static com.amap.api.location.AMapLocationClientOption.AMapLocationProtocol;
import static com.amap.api.location.AMapLocationClientOption.GeoLanguage;
...
public class SpeedDetectionActivity extends BaseActivity {
    ...
    protected void initView() {
        bindingToolbar(mToolBar, I18nUtils.getString(R.string.tool_speed_detection));
    }
    ...
    protected void initData() {
        PermissionsManager.getInstance().requestPermissionsIfNecessaryForResult(this, needPermissions, new PermissionsResultAction() {
            @Override
    ...
    AMapLocationListener locationListener = new AMapLocationListener() {
        ...
        public void onLocationChanged(AMapLocation location) {
            if (isDestroy(SpeedDetectionActivity.this)) {
                return;
            }
            if (null != location) {
                ...
                if (location.getErrorCode() == 0) {
                    ...
                    tv_location.setText("地址: " + location.getAddress());
                    sb.append("地    址    : " + location.getAddress() + "\n");
                    sb.append("兴趣点    : " + location.getPoiName() + "\n");
                    //定位完成的时间
                    sb.append("定位时间: " + TimeUtils.formatDateToStr(location.getTime(), "yyyy-MM-dd HH:mm:ss") + "\n");
                } else {
                    //定位失败
                    sb.append("定位失败" + "\n");
                ...
                sb.append("****************").append("\n");
                //定位之后的回调时间
                sb.append("回调时间: " + TimeUtils.formatDateToStr(System.currentTimeMillis(), "yyyy-MM-dd HH:mm:ss") + "\n");
