...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        ...
        BrowseTrackDao.createTable(db, ifNotExists);
        CollectionDao.createTable(db, ifNotExists);
        HistoryExpressDao.createTable(db, ifNotExists);
        BookChapterDao.createTable(db, ifNotExists);
        BookRecordDao.createTable(db, ifNotExists);
        CollectBookDao.createTable(db, ifNotExists);
        RecommendBookDao.createTable(db, ifNotExists);
    }
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        ...
        BrowseTrackDao.dropTable(db, ifExists);
        CollectionDao.dropTable(db, ifExists);
        HistoryExpressDao.dropTable(db, ifExists);
        BookChapterDao.dropTable(db, ifExists);
        BookRecordDao.dropTable(db, ifExists);
        CollectBookDao.dropTable(db, ifExists);
        RecommendBookDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(BrowseTrackDao.class);
        registerDaoClass(CollectionDao.class);
        registerDaoClass(HistoryExpressDao.class);
        registerDaoClass(BookChapterDao.class);
        registerDaoClass(BookRecordDao.class);
        registerDaoClass(CollectBookDao.class);
        registerDaoClass(RecommendBookDao.class);
    }
