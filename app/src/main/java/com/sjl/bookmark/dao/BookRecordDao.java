...
*/
public class BookRecordDao extends AbstractDao<BookRecord, String> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, BookRecord entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, BookRecord entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final String updateKeyAfterInsert(BookRecord entity, long rowId) {
        return entity.getBookId();
    }
    
    @Override
    public String getKey(BookRecord entity) {
        if(entity != null) {
            return entity.getBookId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(BookRecord entity) {
