...
public class BookDetailDto extends BaseZhuiShu {


    private BookDetail bookList;

    public BookDetail getBookList() {
        return bookList;
    }

    public void setBookList(BookDetail bookList) {
    ...
    public class BookDetail {
        ...
        private CollectBook collBookBean;
        ...
        public CollectBook getCollBookBean() {
        ...
        public CollectBook createCollBookBean() {
            CollectBook bean = new CollectBook();
            bean.set_id(get_id());
