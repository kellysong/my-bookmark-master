...
import com.sjl.bookmark.entity.zhuishu.table.BookAuthor;
import com.sjl.bookmark.entity.zhuishu.table.BookHelpful;
...
public class HotCommentDto extends BaseZhuiShu {

    private List<HotComment> reviews;

    public List<HotComment> getReviews() {
        return reviews;
    }

    public void setReviews(List<HotComment> reviews) {
    ...
    public static class HotComment {
        ...
        public BookHelpful getHelpful() {
            return helpful;
        }

        public void setHelpful(BookHelpful helpful) {
